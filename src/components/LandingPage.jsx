...
const LandingPage = () => {
  ...
  return (
    <div className="d-flex flex-column align-items-center justify-content-center vh-100 bg-dark text-center">
      ...
      <button
        className="btn btn-sm btn-success position-fixed"
      ...
      {showHint && (
        ...
        <div
          className="p-4 mb-3"
          style={{
            backgroundColor: "rgba(255, 55, 6, 0.8)",
            borderRadius: "8px",
            boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.2)",
            width: "300px",
          }}
        >
          ...
          <button className="btn btn-xl" style={{ backgroundColor: "green" }} onClick={handleLogin} >
            LOGIN
          </button>
    </div>
    </div>
